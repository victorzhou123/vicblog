...
func (c *loginServiceClient) Login(ctx context.Context, in *ReqLogin, opts ...grpc.CallOption) (*RespLogin, error) {
	out := new(RespLogin)
...
func (UnimplementedLoginServiceServer) Login(context.Context, *ReqLogin) (*RespLogin, error) {
